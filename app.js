...
element is the product of those numbers, and the second element is a string that EXACTLY follows this example and
...
for the testMultiply() function and see if the test passes.*/
...
IMPORTANT DETAIL: You may not use the arithmetic operators + and * in this function. To do addition, use your sum()
function, and to do multiplication, use your multiply() function that you've already created. You're going to have
to be resourceful to figure out how to do this.

Test this function by hand in the console to get it working, and when you think it is finished, uncomment the call
for the testSumAndMultiply() function and see if the test passes.*/

// Write your code here
function sumAndMultiply(a, b, c) { //eslint-disable-line
  return [sum(a, sum(b, c)[0])[0], multiply(a, multiply(b, c)[0])[0], a + ' and ' + b + ' and ' + c + ' sum to ' +
  sum(a, sum(b, c)[0])[0] + '.', 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' +
...
/////////////////////////////////////
/* Problem 4
Write a function called sumArray() that takes in an array of numbers as its single argument and then returns an
array where the first element is the sum of the numbers in the array, and the second element is a string that
...
Test this function by hand in the console to get it working, and when you think it is finished, uncomment the
call for the testSumArray() function and see if the test passes.*/

// Write your code here
var testArray = [2, 3, 4]; //eslint-disable-line

function sumArray(sumArr) { //eslint-disable-line
  return [sum(sumArr[0], sum(sumArr[1], sumArr[2])[0])[0], sumArr[0] + ',' + sumArr[1] + ',' +
  sumArr[2] + ' was passed in as an array of numbers, and ' + sum(sumArr[0], sum(sumArr[1], sumArr[2])[0])[0]
  + ' is their sum.'];
}
...
IMPORTANT DETAIL: You may not use the arithmetic operator * in this function. To do multiplication, use your
multiply() function that you've already created. You're going to have to be resourceful to figure out how to
do this. This function should handle an array containing three elements.

Test this function by hand in the console to get it working, and when you think it is finished, uncomment the
call for the testMultiplyArray() function and see if the test passes.*/

// Write your code here
function multiplyArray(multArr) { //eslint-disable-line
  return [multiply(multArr[0], multiply(multArr[1], multArr[2])[0])[0], 'The numbers ' + multArr[0] + ','
  + multArr[1] + ',' + multArr[2] + ' have a product of ' +
...
IMPORTANT DETAIL: You may not use the arithmetic operator * in this function. To do multiplication, use your
multiply() function that you've already created. You're going to have to be resourceful to figure out how
to do this.
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  for(i = 1; i < dynamicArray.length - 1; i++) {
    list = list + dynamicArray[i] + ',';
  }
  list = list + dynamicArray[dynamicArray.length - 1];
  return [x, 'The numbers ' + list + ' have a product of ' + x + '.'];
}
